...
public class Jetty {
  ...
  private static String applicationClass = "edu.hawaii.solardecathlon.SolarDecathlonApplication";
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      server.start();
      System.out.printf("%nApplication at http://localhost:%s/%s. Press return to exit.%n",
          port, contextPath);
