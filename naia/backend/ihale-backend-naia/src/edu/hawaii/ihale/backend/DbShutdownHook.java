...
/**
 * Provides a shutdown hook specifying code to be run at the end of this application's life. For
 * more details, see: http://onjava.com/pub/a/onjava/2003/03/26/shutdownhook.html
 * 
...
public class DbShutdownHook extends Thread {
  ...
  /**
   * Called from within the ContactDAO to pass the Environment and EntityStore to be closed. Note
   * there can only be one of each of these in this application.
   * 
