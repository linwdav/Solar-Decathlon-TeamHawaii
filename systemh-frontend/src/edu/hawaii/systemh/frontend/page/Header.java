...
import edu.hawaii.systemh.frontend.page.hvac.Hvac;
import edu.hawaii.systemh.frontend.page.lighting.Lighting;
import edu.hawaii.systemh.frontend.weatherparser.CurrentWeather;
...
public class Header extends WebPage {
  ...
  public Header() {
    ...
    add(CSSPackageResource.getHeaderContribution(edu.hawaii.systemh.frontend.page.Header.class,
        "style.css", screenContainer));

    // Add Javascript for use in all pages
    add(JavascriptPackageResource.getHeaderContribution(
        edu.hawaii.systemh.frontend.page.Header.class, "javascripts/jquery.min.js"));

    add(JavascriptPackageResource.getHeaderContribution(
        edu.hawaii.systemh.frontend.page.Header.class, "javascripts/jquery-ui.min.js"));

    add(JavascriptPackageResource.getHeaderContribution(
        edu.hawaii.systemh.frontend.page.Header.class, "javascripts/jquery-ui-1.8.7.custom.js"));

    // For table sorter
    add(JavascriptPackageResource.getHeaderContribution(
        edu.hawaii.systemh.frontend.page.Header.class, "javascripts/jquery.tablesorter.min.js"));

    add(JavascriptPackageResource.getHeaderContribution(
        edu.hawaii.systemh.frontend.page.Header.class, "javascripts/jquery.effects.core.js"));
    add(JavascriptPackageResource.getHeaderContribution(
        edu.hawaii.systemh.frontend.page.Header.class, "javascripts/jquery.ui.core.js"));

    add(JavascriptPackageResource.getHeaderContribution(
        edu.hawaii.systemh.frontend.page.Header.class, "javascripts/jquery.ui.widget.js"));
    add(CSSPackageResource.getHeaderContribution(edu.hawaii.systemh.frontend.page.Header.class,
        "jqueryUI.css", screenContainer));

    add(JavascriptPackageResource.getHeaderContribution(
        edu.hawaii.systemh.frontend.page.Header.class, "javascripts/main.js"));

    // For Time Picker and Color chooser
    add(JavascriptPackageResource.getHeaderContribution(
        edu.hawaii.systemh.frontend.page.Header.class, "javascripts/jquery.icolor.js"));
    add(CSSPackageResource.getHeaderContribution(edu.hawaii.systemh.frontend.page.Header.class,
        "timePicker.css", screenContainer));
    add(JavascriptPackageResource.getHeaderContribution(
        edu.hawaii.systemh.frontend.page.Header.class, "javascripts/jquery.timePicker.js"));

    // For Date Picker
    add(CSSPackageResource.getHeaderContribution(edu.hawaii.systemh.frontend.page.Header.class,
        "datePicker.css", screenContainer));
    add(JavascriptPackageResource.getHeaderContribution(
        edu.hawaii.systemh.frontend.page.Header.class, "javascripts/jquery.ui.datepicker.js"));
