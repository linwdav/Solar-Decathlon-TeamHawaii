...
/**
 * A data dictionary that defines the various systems, devices, fields of the devices 
 * such as their keys and data type (i.e., pH=Double, Oxygen=Double) in the solar
 * decathlon home. Use for dynamic validation when converting XML data to object fields.
 *
...
public class DataDictionary {
  ...
  /**
   * Returns a Map such that the key value is the device state key (i.e., Temp, 
   * Oxygen) and the value mapped to the key is the value type (i.e., Double, Long).
   *
  ...
  /**
   * Returns a complicated Map of a Map containing all the system data defined
