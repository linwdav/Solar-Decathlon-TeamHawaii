...
/**
 * The database entity representation of the SystemStateEntry object specific to the iHale house
 * systems.
...
public class IHaleSystemStateEntry {
  ...
  /**
   * The timestamp (UTC format) indicating when this state info was collected. This is also the
   * Primary Key.
   */
  @PrimaryKey
  ...
  /**
   * The name of the System. Example: "Aquaponics". This is also the Secondary Key. There can be
   * many entries with the same system name but must have a unique timestamp (the primary key)
   * value.
   */
  ...
  /**
   * Purpose of this method is to suppress errors and pass verify. Delete this method later when the
   * variables are actually used locally.
   */
  ...
  /**
   * Sets the double value of the passed key to value. Any previous value will be overwritten.
  ...
  /**
   * Sets the long value of the passed key to value. Any previous value will be overwritten.
   * @param key The string key.
   * @param value The double value.
   */
  ...
  public String toString() {
    return String.format("[StateEntry System: %s Device: %s Time: %s (%s) State: %s %s %s]",
