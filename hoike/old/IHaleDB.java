...
//
//  /** The PrimaryIndex accessor for state entries. */
//  private static PrimaryIndex<String, IHaleEntry> primaryIndex;
//
...
//
//  /**
//   * Sends a message to the specified system and device instructing them to perform this command
//   * along with any other required arguments.
...
//    System.out.format("Sending the %s system the command %s with args %s%n", systemName, command,
//        args);
//  }
//}
