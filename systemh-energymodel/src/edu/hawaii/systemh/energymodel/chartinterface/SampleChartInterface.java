...
public class SampleChartInterface implements EnergyManagementChartInterface {
  ...
  /**
   * Assigns a repository to the energy model.
   * 
   * @param repository The repository to attach.
   */
  public SampleChartInterface(Repository repository) {
  ...
  public double powerGenerated(Long startTime, Long endTime) {
    ...
    // Get a list of the enery generated by PV.
    repository.getPhotovoltaicEnergyDuringInterval(startTime, endTime);
    return 0;
  }
