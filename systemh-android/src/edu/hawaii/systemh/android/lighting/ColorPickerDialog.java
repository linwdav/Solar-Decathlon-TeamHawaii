...
/**
 * A color picker dialog. Obtained from the source below:
...
public class ColorPickerDialog extends Dialog {
  ...
  /**
   * The classes that implements this class must override the colorChanged method.
   * 
   * @author Yougli
   * 
   */
  public interface OnColorChangedListener {
    ...
    /**
     * Invoked when a user clicks on 'confirm'.
     * 
     * @param key The key.
  ...
  private static class ColorPickerView extends View {
     ...
     * 
     * @param c The context.
     * @param l The onColorChangedListener.
     * @param color The color.
    ...
    private void updateMainColors() {
      ...
      for (int y = 0; y < 256; y++) {
        for (int x = 0; x < 256; x++) {
          if (y == 0) {
            mMainColors[index] =
                Color.rgb(255 - (255 - Color.red(mainColor)) * x / 255,
            ...
            mMainColors[index] =
                Color.rgb((255 - y) * Color.red(topColors[x]) / 255,
    ...
    protected void onDraw(Canvas canvas) {
      ...
      canvas.drawText(getResources().getString(R.string.Close), 202, 340, mPaint);
    }
  ...
  /**
   * The constructor for the ColorPickerDialog.
   * 
   * @param context The context.
   * @param listener The onColorChangedListener.
   * @param key The key.
