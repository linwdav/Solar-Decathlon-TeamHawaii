...
public class SystemData {
     ...
     * 
     * @param systemName
     *            The name of the system you want to get data from
     */
    ...
    public void setAquaponicsTemp(int value) {
        ...
        try {
            String putUrl = "http://" + ipAddress
                    + ":8111/AQUAPONICS/command/SET_TEMPERATURE?arg=" + value;
    ...
    public void setPh(double value) {
        ...
        try {
            String putUrl = "http://" + ipAddress
                    + ":8111/AQUAPONICS/command/SET_PH?arg=" + value;
            ClientResource putClient = new ClientResource(putUrl);
            putClient.put(putUrl);
            putClient.release();
        } 
    ...
    public void setWaterLevel(double value) {
        ...
        try {
            String putUrl = "http://" + ipAddress
                    + ":8111/AQUAPONICS/command/SET_WATER_LEVEL?arg=" + value;
            ClientResource putClient = new ClientResource(putUrl);
            putClient.put(putUrl);
            putClient.release();
        } 
    ...
    public void setNutrients(double value) {
        ...
        try {
            String putUrl = "http://" + ipAddress
                    + ":8111/AQUAPONICS/command/SET_NUTRIENTS?arg=" + value;
            ClientResource putClient = new ClientResource(putUrl);
            putClient.put(putUrl);
            putClient.release();
        } 
    ...
    public void feedFish(double value) {
        ...
        try {
            String putUrl = "http://" + ipAddress
                    + ":8111/AQUAPONICS/command/FEED_FISH?arg=" + value;
            ClientResource putClient = new ClientResource(putUrl);
            putClient.put(putUrl);
            putClient.release();
        } 
    ...
    public void harvestFish(int value) {
        ...
        try {
            String putUrl = "http://" + ipAddress
                    + ":8111/AQUAPONICS/command/HARVEST_FISH?arg=" + value;
            ClientResource putClient = new ClientResource(putUrl);
            putClient.put(putUrl);
            putClient.release();
        } 
    ...
    public void setHvacTemp(int value) {
        ...
        try {
            String putUrl = "http://" + ipAddress
                    + ":8111/HVAC/command/SET_TEMPERATURE?arg=" + value;
            ClientResource putClient = new ClientResource(putUrl);
            putClient.put(putUrl);
            putClient.release();
        } 
    ...
    public void setLightingLevel(int value, String room) {
        ...
        try {
            ...
            String putUrl = "http://" + ipAddress
                    + ":8111/LIGHTING/command/SET_LIGHTING_LEVEL?arg=" + value
    ...
    public void setLightingEnabled(boolean value, String room) {
        ...
        try {
            String putUrl = "http://" + ipAddress
                    + ":8111/LIGHTING/command/SET_LIGHTING_ENABLED?arg="
                    + value + "&room=" + room.toUpperCase();
            ClientResource putClient = new ClientResource(putUrl);
            putClient.put(putUrl);
            putClient.release();
        } 
    ...
    public void setLightingColor(String value, String room) {
        ...
        try {
            String putUrl = "http://" + ipAddress
                    + ":8111/LIGHTING/command/SET_LIGHTING_COLOR?arg=" + value
                    + "&room=" + room.toUpperCase();
            ClientResource putClient = new ClientResource(putUrl);
            putClient.put(putUrl);
            putClient.release();
