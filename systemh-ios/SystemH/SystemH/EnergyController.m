    ...
    switch ([indexPath section]) {
        ...
        case 0:
            if ([indexPath row] == 0) {
                ...
                cell.detailTextLabel.text = [(NSString *)[[self.photovoltaicParser stateData] objectForKey:PV] truncateDecimals:2];
            }
            else {
                cell.textLabel.text = @"Energy Consumed";
                cell.detailTextLabel.text = [(NSString *)[[self.electricParser stateData] objectForKey:ELECTRIC] truncateDecimals:2];
            }
